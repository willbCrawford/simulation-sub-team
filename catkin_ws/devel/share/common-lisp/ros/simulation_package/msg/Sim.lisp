...
(cl:in-package simulation_package-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Sim>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Sim)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name simulation_package-msg:<Sim> is deprecated: use simulation_package-msg:Sim instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Sim>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulation_package-msg:header-val is deprecated.  Use simulation_package-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <Sim>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulation_package-msg:id-val is deprecated.  Use simulation_package-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'prob-val :lambda-list '(m))
(cl:defmethod prob-val ((m <Sim>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulation_package-msg:prob-val is deprecated.  Use simulation_package-msg:prob instead.")
  (prob m))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Sim>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulation_package-msg:x-val is deprecated.  Use simulation_package-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Sim>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulation_package-msg:y-val is deprecated.  Use simulation_package-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'gl-val :lambda-list '(m))
(cl:defmethod gl-val ((m <Sim>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulation_package-msg:gl-val is deprecated.  Use simulation_package-msg:gl instead.")
  (gl m))

(cl:ensure-generic-function 'rb-val :lambda-list '(m))
(cl:defmethod rb-val ((m <Sim>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulation_package-msg:rb-val is deprecated.  Use simulation_package-msg:rb instead.")
  (rb m))

(cl:ensure-generic-function 'lb-val :lambda-list '(m))
(cl:defmethod lb-val ((m <Sim>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulation_package-msg:lb-val is deprecated.  Use simulation_package-msg:lb instead.")
  (lb m))

(cl:ensure-generic-function 'bb-val :lambda-list '(m))
(cl:defmethod bb-val ((m <Sim>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulation_package-msg:bb-val is deprecated.  Use simulation_package-msg:bb instead.")
  (bb m))

(cl:ensure-generic-function 'time-val :lambda-list '(m))
(cl:defmethod time-val ((m <Sim>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulation_package-msg:time-val is deprecated.  Use simulation_package-msg:time instead.")
  (time m))
